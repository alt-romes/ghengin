...
game = do
  ...
  newEntity (Position 0, Velocity 1, Mesh [Vertex (vec3 0.0 (-0.5) 1) (vec3 0 0 0) (vec3 1 0 0), Vertex (vec3 0.5 0.5 1) (vec3 0 0 0) (vec3 0 1 0), Vertex (vec3 (-0.5) 0.5 1) (vec3 0 0 0) (vec3 0 0 1)])
